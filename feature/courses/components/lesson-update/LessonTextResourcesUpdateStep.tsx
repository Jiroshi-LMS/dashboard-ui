...
type LessonTextResourcesUpdateProps = {
  lessonId: string | null;
  resourceData: LessonResourcesAll | null
};

const LessonTextResourceUpdateStep: React.FC<LessonTextResourcesUpdateProps> = ({ lessonId, resourceData }) => {
  ...
  useEffect(() => {
    ...
    setRelatedLinks(() => {
      const arr: LessonRelatedLink[] = []
      resourceData?.related_links?.forEach((relatedLink: LessonRelatedLink) => {
        arr.push(relatedLink)
      })
      return arr
    })
  }, [resourceData])
...
export default LessonTextResourceUpdateStep;
