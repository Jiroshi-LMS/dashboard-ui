...
type StudentListFilterProps = {
    studentFilters: StandardFilters
    setStudentFilters: React.Dispatch<SetStateAction<StandardFilters>>
...
const StudentListFilters = ({ studentFilters, setStudentFilters, setSearch, handleFilterChange }: StudentListFilterProps) => {
    return (
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <DateRangePicker
                                ...
                                value={{
                                    from: studentFilters?.filters?.created_at_after
                                        ? utcToLocalDate(studentFilters.filters.created_at_after)
                                        : undefined,
                                    to: studentFilters?.filters?.created_at_before
                                        ? utcToLocalDate(
                                            studentFilters.filters.created_at_before
                                        )
                                        : undefined,
                                }}
                            />
