    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 selection:text-primary">
            ...
            <main className="pt-32 pb-24 px-6 w-full">
                ...
                >
                    <h1 className="text-4xl font-bold mb-4 text-foreground tracking-tight text-center">Terms & Conditions</h1>
                    ...
                    <div className="prose max-w-none space-y-12 text-muted-foreground leading-relaxed">
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">3. User Eligibility and Account Responsibility</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">4. Subscriptions, Payments, and Billing</h2>
                            <p>
                            ...
                            <div className="bg-muted border border-border p-6 rounded-xl">
                                <h3 className="font-bold text-foreground mb-2">Payment Processing</h3>
                                <p className="mb-4">
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">5. Refunds and Cancellations</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">6. Acceptable Use of the Platform</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">7. Intellectual Property Rights</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">8. Limitation of Liability</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">9. Account Suspension or Termination</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">10. Governing Law</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-foreground border-b border-border pb-2">11. Changes to Terms</h2>
                            <p>
