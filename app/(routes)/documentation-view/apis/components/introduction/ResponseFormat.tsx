...
const ResponseFormat = () => {
    return (
        <div id="response-format" className="mb-16 scroll-mt-32">
            ...
            <pre className="bg-slate-900 text-slate-100 rounded-lg p-4 text-sm overflow-x-auto mb-6">
                <code>{`{
  "status": true,
  "results": true,
  "message": "Success",
  ...
  "data": {
    "results": [
      {
        "id": "a12f3c9b-4e91-44de-bf6a-9f1a2a6d90ab",
        "name": "Advanced Django APIs",
        "is_active": true,
        "created_at": "2025-01-10T09:15:12Z"
      },
      {
        "id": "b93c0e71-8f3a-4c7d-9c18-6f2f5b19a442",
        "name": "System Design Fundamentals",
        "is_active": false,
        "created_at": "2025-01-08T14:02:47Z"
      }
    ],
    "pagination": {
      "page": 1,
  ...
  "error_code": null
            ...
            <p className="text-slate-600 leading-relaxed">
                ...
                <code className="mx-1 font-mono">null</code>, and a non-null
